  ...
  return (
    <>
      ...
      <section className="introduce">
        ...
        >
          <div className="text">
            <p>트렌디한 개발자가 되기 위해서는 나날이 변화하는 IT 트랜드에 관심을 가지고 따라잡으려는 노력하겠습니다.<br className="pcOnly"/> <span className="wsnr">트렌디한 기술들에</span> 관심을 가지고 공부 중이며, 제가 관심 있는 분야를 공부하는 것에 매우 재미를 느끼고 있습니다. 꾸준히 프론트엔드 개발 관련 기사나 컬럼들을 찾아보고 레퍼런스를 찾아보며, 필요에 의해 의무적으로 공부하는 것이 아닌, 프론트엔드 개발에 매료되어 자발적으로 공부하는 프론트엔드 개발자가 되고 싶습니다.</p>
          </div>
          <div className="text">
